...
namespace SMSAPI.Persistence.Migrations
{
    ...
    [Migration("20260418195030_AddCustomerAndOrderUpdates")]
    partial class AddCustomerAndOrderUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMSAPI.Domain.Entities.Customer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSAPI.Domain.Entities.Order", b =>
                {
                    b.HasOne("SMSAPI.Domain.Entities.Customer", "Customer")
                        .WithMany("Orders")
